...
POT1_POS_OUTFOOD_LEVEL = 4.20  # 1号锅外倒菜位，水平位
POT1_POS_INFOOD_FLIP  = 5.05  # 1号锅内倒菜位,翻转位
POT1_POS_INFOOD_LEVEL = 4.2  # 1号锅内倒菜位，水平位
POT1_POS_WASHPOT_FLIP  = -11.8  # 1号锅洗锅位,翻转位
POT1_POS_WASHPOT_LEVEL = 4.2  # 1号锅洗锅位，水平位
POT1_POS_FIREPOT_FLIP  = 0  # 1号锅烧菜位,翻转位
POT1_POS_FIREPOT_LEVEL = 0  # 1号锅烧菜位，水平位

POT_POS_MOVE_SAFE_FLIP = 5.02  # 锅移动安全位,翻转位
